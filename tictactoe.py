def TicTacToe() :
    ...
    while not end:
        ...
        if end == True:
            ...
            Turn("O")
# Drive Code
print('Welcome to the Tic Tac Toe!\n implemented by using magic square appraoch')
print("Assumptions:")
print("1. It is a game between two human users only")
print("2. Machine will play first")
print("3. Initial Board Position is and each square can be represented as position/ element of machine")
print("4. One user is Human and user is machine")
TicTacToe()